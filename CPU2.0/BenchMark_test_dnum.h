#ifndef HHBENCHDNUM_H
#define HHBENCHDNUM_H
...
class BenchMark_test_dnum {
 public:
  BenchMark_test_dnum(std::string PATH, std::string FILENAME,
  ...
  void HHHyperBench_simd(uint32_t MEMORY, uint32_t HASH_NUM = 2,
...
//    HASH_NUM = 5;
...
#ifndef SKEW
    CompareSubset(estTuple, tuplesMp, HASH_NUM);
#else
    CompareSubset_SKEW(estTuple, tuplesMp, HASH_NUM);
#endif
  ...
  void HHHyperBench_murmurhash(uint32_t MEMORY, uint32_t HASH_NUM = 2,
...
//    HASH_NUM = 5;
  ...
  void HHHyperBench_precalculate(uint32_t MEMORY, uint32_t HASH_NUM = 2,
...
*/
 private:
  ...
  // mp : estimate
  // record : real
  void CompareSubset(T mp, T record, int dnum) {
    double aae_sum = 0.0;
    double are_sum = 0.0;
#ifndef AVERAGE
    double NUM = 0;
    ...
    ofs << "d=" << dnum << ":" << benchname << " " << memory << " " << aae_sum / NUM << " "
  ...
  // mp : estimate
  // record : real
  void CompareSubset_SKEW(T mp, T record, int dnum) {
