#ifndef PRECALCULATE_H
#define PRECALCULATE_H
...
class OurHyper_precalculate {	
 public:
  OurHyper_precalculate(uint32_t _MEMORY, uint32_t _HASH_NUM = 2,
           std::string _name = "OurHyper_precalculate") {
    this->name = _name;
